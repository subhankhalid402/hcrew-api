                ...
                <div class="client-info-right">
                    <table class="maintable">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>{{amount_formatted($data->currency, $data->total)}}</p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
{{--                        echo \Milon\Barcode\DNS1D::getBarcodeHTML('4445645656', 'PHARMA2T');--}}
                        @php
                        $file_path = env('BASE_URL') . 'public/uploads/invoice_pdf/quotation_invoice/QUT-INV-' . $data->id . '.pdf';
                        @endphp
                        <img src="data:image/png;base64,' {{\Milon\Barcode\DNS1D::getBarcodePNG('90', 'C39+')}} '" alt="barcode"   />

                        {{--                        <img src="data:image/png;base64,{{ base64_encode($generatorPNG->getBarcode(env('BASE_URL') . 'public/uploads/invoice_pdf/quotation_invoice/QUT-INV-' . $data->id . '.pdf', $generatorPNG::TYPE_CODE_128)) }}">--}}
                    </div>
                </div>
            </div>
            <div style="clear: both"></div>
