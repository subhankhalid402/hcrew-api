    ...
    <div class="page">
        <div class="subpage">
                ...
                <tr>
                    ...
                    <td align="right">
                        ...
                        <div class="quatition-info">
                            <p>Contract Title: [{{$data->title}}]</p>
                            <p>Contract Status: [{{$data->contract_status}}]</p>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <div class="client-info-wrapper">
                <div class="client-info-left">
                    <table class="maintable">
                        ...
                        <tr>
                            <th>
                                <h4 class="client-text">Client Information:</h4>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            <td>
                                <p>Name: [{{$data->client->name . ' ' . $data->client->short_name}}]</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <p>Contact No: [{{$data->client->phone_no}}]</p>
                            </td>
                        </tr>
                        <tr>
                        <tr>
                ...
                <div class="client-info-right">
                    <table class="maintable">
                        ...
                        <tr>
                            <td>
                                <p>Construction Start Date : [{{$data->start_date_format}}]</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p>Construction Deadline : [{{$data->end_date_format}}]</p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <table class="maintable">
                ...
                <tbody>
                <tr>
                    <td class="empty-td" colspan="3"></td>
                </tr>
                <tr>
                    <td class="w-60">1</td>
                    <td class="w-520">
...
{{--                        <h4>Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>_________________________</span></h4>--}}
                    </div>
                </div>
                <div class="client-info-right">
                    <table class="maintable">
